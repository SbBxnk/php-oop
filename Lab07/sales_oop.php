...
class Sales
{
    ...
    public function __construct($para_price, $para_unit )
    {
        $this->price = $para_price;
        $this->unit = $para_unit;
        $this->discount = 0;    
    }
...
if (isset($_POST["cal"])) {
    ...
    $sales = new Sales($price, $unit);
    $total = $sales->getTotal();
    $discount = $sales->Discount($total);
...
<div class="container-fluid pt-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 justify-content-center mt-0">
        <h2 class="fw-bold text-center mt-3 mb-3">คำนวณยอดการสั่งซื้อ OOP</h2>
    ...
    <div class=" button d-flex align-items-center justify-content-center">
        <a href="?p=Lab07_oop" class="col-3 btn btn-secondary">กลับ</a>
    </div>
</div>